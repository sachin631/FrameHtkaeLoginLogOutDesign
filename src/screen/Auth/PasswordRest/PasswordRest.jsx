    ...
    <div className="lg:hidden">
      ...
      <div className='sign-up-form-input-shadow container mx-auto bg-white grid grid-cols-10 rounded-xl overflow-hidden'>
        <div className="flex flex-col justify-between col-span-4 bg-[#FFF6F2] overflow-hidden">
          ...
          <div className="mb-8">
            <img src='/assets/undraw_authentication_re_svpt .svg' className='px-[62px] py-[115px] bottom-0'/>
          </div>
        </div>
          ...
          <div className="p-8 w-full max-w-[523px] mt-[-400px]">
            ...
            <form action="" className='w-full mt-[48px] space-y-[30px]'>
              ...
              <div className="mt-[42px]">
                <button className='bg-primary-400 shadow-lg shadow-primary-400/50 text-white text-[18px] p-[13px] leading-[21.78px] rounded-full w-full font hover:bg-[#FA5916] '> <NavLink to="/PasswordRestOtp">Request OTP</NavLink></button>
              </div>         
            </form>
          </div>
        </div>
